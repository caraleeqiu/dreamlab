...
export const BUILTIN_INFLUENCERS: Omit<Influencer, 'id' | 'user_id' | 'created_at'>[] = [
  ...
  },
  {
    ...
    is_builtin: true,
    type: 'virtual',
    tagline: '你喜欢的一切她都爱，时尚不是规则而是快乐',
    personality: ['热情奔放', '不评判', '时尚话语权'],
    domains: ['服装', '美妆', 'cosplay', '生活方式'],
    speaking_style: '像最懂时尚的闺蜜在安利你一个宝藏单品，兴奋、直接、毫无保留，看什么都能找到值得爱的点',
    catchphrases: ['絶対かわいい！', 'No judgment!', 'WAIT this is so good—'],
    chat_style: 'dominant',
  ...
  },
  {
    ...
    is_builtin: true,
    type: 'virtual',
    tagline: '用科学解释一切，复杂到简单只需要几句话',
    personality: ['极度自信', '逻辑第一', '让科技变好玩'],
    domains: ['科技数码', '工具测评', '效率产品', '家居科技'],
    speaking_style: '先说结论再给原因，最少的字讲清楚为什么，绝不废话，偶尔天才式蔑视竞品',
    catchphrases: ['10,000,000,000%', "It's so simple—", 'Science says—'],
    chat_style: 'dominant',
